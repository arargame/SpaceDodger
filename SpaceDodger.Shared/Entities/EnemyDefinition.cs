    ...
    public static class EnemyCatalog
    {
        ...
        private static readonly Dictionary<string, EnemyDefinition> Definitions =
            new Dictionary<string, EnemyDefinition>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["boss_sentinel"] = Def("boss_sentinel", 2, 4f, hp: 340, score: 3500, speed: 28f,
                    weapon: EnemyWeapon.Spread, fire: 0.9f, aim: true, boss: true),
                ["boss_serpent"] = Def("boss_serpent", 2, 6f, hp: 440, score: 4800, speed: 38f,
                    weapon: EnemyWeapon.Spread, fire: 0.8f, aim: true, boss: true),
                ["boss_leviathan"] = Def("boss_leviathan", 2, 4f, hp: 560, score: 6500, speed: 24f,
                    weapon: EnemyWeapon.Heavy, fire: 0.7f, aim: true, boss: true),
                ["boss_phantom"] = Def("boss_phantom", 2, 6f, hp: 700, score: 8500, speed: 40f,
                    weapon: EnemyWeapon.Spread, fire: 0.6f, aim: true, boss: true),
                ["boss_oblivion"] = Def("boss_oblivion", 2, 6f, hp: 900, score: 12000, speed: 36f,
                    weapon: EnemyWeapon.Spread, fire: 0.5f, aim: true, boss: true),
            };
