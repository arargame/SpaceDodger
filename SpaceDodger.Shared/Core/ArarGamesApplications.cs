namespace ArarGames.Core.Applications;

/// <summary>Local copy of the shared Arar Games application catalogue.
/// Keep this in sync with ArarGames.Core when publishing a standalone title.</summary>
public static class ArarGamesApplications
{
    ...
    public const string PaintTrekMicrosoftStore = "https://apps.microsoft.com/detail/9wzdncrdpznh?cid=DevShareMTwPCBIL";
}
